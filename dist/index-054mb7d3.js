...
// src/pdf/args.ts
var pdfUsage = `wordcell pdf \u2014 save a local or public remote PDF as an auditable Markdown bundle
...
async function runPdfCapture(options, dependencies = {}) {
  ...
  const workspaceDirectory = options.workspaceDirectory ?? mkdtempSync2(join4(tmpdir(), "hraness-wordcell-pdf-"));
  try {
...
async function preparePdfSource(input, options = {}, dependencies = {}) {
  ...
  const makeTemporaryDirectory = dependencies.makeTemporaryDirectory ?? (() => mkdtempSync3(join5(tmpdir2(), "hraness-wordcell-pdf-source-")));
