...
description: Replace with the recurring Wordcell request that should select this skill.
---
...
State the exact recurring Wordcell request that this skill owns.

## Do not use when

Route generic query, capture, plan, percolation, refresh, and validation work
to the public `wordcell` skill. State any additional exclusions that prevent an
...
Name the narrow checks that demonstrate the approved result and the Wordcell
